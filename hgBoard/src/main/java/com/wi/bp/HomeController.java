...
public class HomeController {
	...
	public String pWriteP(PostV postV, RedirectAttributes redirectAttributes) 
	throws Exception{
	...
	public String pList(Model model) throws Exception {
		...
		logger.info("글 목록");
		model.addAttribute("Posts", boardService.listAll());
	...
	public String pModifyP(PostV postV, RedirectAttributes redirectAttributes) 
	throws Exception{
	...
	public String pDeleteP(@RequestParam("postNo") int postNo, RedirectAttributes redirectAttributes) 
	throws Exception{
